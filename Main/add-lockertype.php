                    ...
                    <div class="card-body">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" id="lockersize" name="lockersize">
                          ...
                          <option value="Plastic locker">Plastic locker</option>
                          <option value="Bike locker">Bike locker</option>
                          <option value="Door locker">Door locker</option>
                        </select>
                      </div>

                      <div class="form-group">
                        <label for="text">Price of Locker</label>
                        <input type="text" class="form-control" id="lockerprice" name="lockerprice" title="10 numeric characters only" required>
                      </div>
                    </div>
                    <!-- /.card-body -->
