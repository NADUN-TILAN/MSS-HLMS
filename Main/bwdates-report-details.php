...
?>
  ...
  <head>
    ...
    <title>HLMS | Sales Dates Report Details</title>
            ...
            <div class="row mb-2">
              ...
              <div class="col-sm-4">
                <ol class="breadcrumb float-sm-right">
                  ...
                  <li class="breadcrumb-item active">Sales Dates Report Details</li>
                </ol>
              </div>
            </div>
          </div><!-- /.container-fluid -->
                ...
                <div class="card">
                  ...
                  <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Sales Dates Report Details</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
