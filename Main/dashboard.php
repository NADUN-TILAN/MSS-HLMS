            ...
            <div class="row">
              ...
              <div class="col-lg-6 col-6">
                ...
                <div class="small-box bg-danger">
                  <div class="inner">
                    <?php $query3 = mysqli_query($con, "select ID from tblsupplycomp");
                    $activelocker = mysqli_num_rows($query3);
                    ?>
                    <h3><?php echo $activelocker; ?></h3>

                    <p>Supply Companies</p>
                  </div>
                  <div class="icon">
                    <i class="ion-person-stalker"></i>
                  </div>
                  <a href="manage-supplydep.php" class="small-box-footer">More info <i class="fas fa-arrow-circle-right"></i></a>
                </div>
              </div>
