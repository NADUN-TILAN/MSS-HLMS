...
if (strlen($_SESSION['aid']) == 0) {
  ...
  if (isset($_POST['update'])) {
    ...
    $query = mysqli_query($con, "update tblbanker set AdminName='$fname',MobileNumber='$mobileno',Email='$email' where UserType=0 and ID='$subadminid'");
    if ($query) {
  ...
  <body class="hold-transition sidebar-mini">
    <div class="wrapper">
      ...
      <div class="content-wrapper">
        ...
        $query = mysqli_query($con, "select * from tblbanker where UserType=0 and ID='$said'");
        $cnt = 1;
