...
?>
  ...
  <head>
    ...
    <title>HLMS | Search Report Details</title>
          ...
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-8">
                ...
                <h1>Search Locker Details againt keyword "<?php echo $searchby; ?>"</h1>
              </div>
              <div class="col-sm-4">
                ...
                <div class="card">
                  ...
                  <div class="card">
                    <div class="card-header">
                      <h3 class="card-title">Search Locker Details</h3>
                    </div>
                    <!-- /.card-header -->
                    <div class="card-body">
                      <table id="example1" class="table table-bordered table-striped">
                        ...
                        <tbody>
                          <?php $query = mysqli_query($con, "select * from tblassignlocker where LockerNumber like '%$searchby%' || KeyNumber like '%$searchby%' || FullName like '%$searchby%'");
                          $cnt = 1;
